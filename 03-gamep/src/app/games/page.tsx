                                ...
                                games.map((game) => (
                                        ...
                                        <div className="relative ">
                                                <img
                                                        src={game.image}
                                                        alt={game.title}
                                                        className="w-full h-42  rounded-lg group-hover:opacity-80 transition"
                                                />
                                        <div className="absolute inset-0 bg-purple bg-opacity-30 rounded-lg opacity-0 group-hover:opacity-100 transition"></div>
                                        </div>
